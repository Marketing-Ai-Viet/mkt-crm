...
export class UserService {
  ...
  private async createWorkspaceMember(
    ...
    return this.workspaceMemberService.createWorkspaceMember({
      ...
      officialStartDate: input.officialStartDate ?? null,
  ...
  private buildUserOutput(
    ...
    return {
      ...
      officialStartDate: savedWorkspaceMember.officialStartDate ?? null,
  ...
  private mapWorkspaceMemberToUserOutput(
    ...
    return {
      ...
      officialStartDate: member.officialStartDate ?? null,
