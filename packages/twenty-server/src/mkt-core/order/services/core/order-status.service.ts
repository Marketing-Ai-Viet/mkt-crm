  ...
  getStatusLabel(status: ORDER_STATUS, lang: 'VI' | 'EN' = 'VI'): string {
    const labels: Record<'VI' | 'EN', Record<ORDER_STATUS, string>> = {
      VI: {
        ...
        [ORDER_STATUS.LICENSE_PENDING]: 'Chờ tạo license',
        [ORDER_STATUS.PROCESSING]: 'Đang xử lý',
        [ORDER_STATUS.COMPLETED]: 'Hoàn thành',
        [ORDER_STATUS.LICENSE_FAILED]: 'Tạo license thất bại',
      ...
      EN: {
        ...
        [ORDER_STATUS.LICENSE_PENDING]: 'License Pending',
        [ORDER_STATUS.PROCESSING]: 'Processing',
        [ORDER_STATUS.COMPLETED]: 'Completed',
        [ORDER_STATUS.LICENSE_FAILED]: 'License Failed',
