...
import { MKT_ATTRIBUTE_DATA_SEEDS_IDS } from 'src/mkt-core/dev-seeder/product-seeder/mkt-attribute-data-seeds.constants';
...
export const MKT_VALUE_DATA_SEEDS_IDS = {
  ...
  MKT_YEAR_DURATION_1_ID: 'c1cd27e6-b995-42da-a406-dc47eda414f3',
  MKT_YEAR_DURATION_2_ID: '86bbd554-3f02-44d4-8179-f3636756c322',
  MKT_YEAR_DURATION_FOREVER_ID: '2a8a16ef-f03b-4408-84ef-ac31f933b000',
  ...
  MKT_365_DAY_DURATION_ID: '5f4e1c4e-1d3b-4f7a-9f7a-1c2e3d4f5a6b',
  MKT_730_DAY_DURATION_ID: '6f5e2d4e-2d4b-5f8a-af8a-2d3e4f5a6b7c', // 365*2
  MKT_3000_DAY_DURATION_ID: '6f5e2d4e-2d4b-5f8a-af8a-2d3e4f5a6b7c', // FOREVER (approx 3000 days)
};

//prettier-ignore
export const MKT_VALUE_DATA_SEEDS: MktValueDataSeed[] = [
  // DURATION values for MKT_DAY_DURATION_ID
  {
    id: MKT_VALUE_DATA_SEEDS_IDS.MKT_365_DAY_DURATION_ID,
    name: '365 Days',
    position: 1,
    mktAttributeId: MKT_ATTRIBUTE_DATA_SEEDS_IDS.MKT_DAY_DURATION_ID,
    createdBySource: 'API',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'John Doe',
  },
  {
    id: MKT_VALUE_DATA_SEEDS_IDS.MKT_730_DAY_DURATION_ID,
    name: '730 Days',
    position: 2,
    mktAttributeId: MKT_ATTRIBUTE_DATA_SEEDS_IDS.MKT_DAY_DURATION_ID,
    createdBySource: 'API',
  ...
  {
    id: MKT_VALUE_DATA_SEEDS_IDS.MKT_3000_DAY_DURATION_ID,
    name: '3000 Days',
    position: 3,
    mktAttributeId: MKT_ATTRIBUTE_DATA_SEEDS_IDS.MKT_DAY_DURATION_ID,
    createdBySource: 'API',
  ...
  // MKT Duration values for MKT_YEAR_DURATION_ID
  {
    id: MKT_VALUE_DATA_SEEDS_IDS.MKT_YEAR_DURATION_1_ID,
    name: '1 Year',
    position: 1,
    mktAttributeId: MKT_ATTRIBUTE_DATA_SEEDS_IDS.MKT_YEAR_DURATION_ID,
    createdBySource: 'API',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'John Doe',
  },
  {
    id: MKT_VALUE_DATA_SEEDS_IDS.MKT_YEAR_DURATION_2_ID,
    name: '2 Years',
    position: 2,
    mktAttributeId: MKT_ATTRIBUTE_DATA_SEEDS_IDS.MKT_YEAR_DURATION_ID,
    createdBySource: 'API',
  ...
  {
    id: MKT_VALUE_DATA_SEEDS_IDS.MKT_YEAR_DURATION_FOREVER_ID,
    name: 'Forever',
    position: 3,
    mktAttributeId: MKT_ATTRIBUTE_DATA_SEEDS_IDS.MKT_YEAR_DURATION_ID,
    createdBySource: 'API',
