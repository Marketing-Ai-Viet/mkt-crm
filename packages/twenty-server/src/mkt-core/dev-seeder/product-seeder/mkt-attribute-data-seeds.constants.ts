...
export const MKT_ATTRIBUTE_DATA_SEEDS_IDS = {
  ...
  MKT_YEAR_DURATION_ID: 'a13160e7-dc57-4ac0-b4e4-e048b35c581e',
  MKT_MONTH_DURATION_ID: '5b5fb235-f992-4cf1-a94c-6d02e89d7e11',
  MKT_DAY_DURATION_ID: '1bae273d-eb98-4cb0-b89a-791d56905c0a',
...
export const MKT_ATTRIBUTE_DATA_SEEDS: MktAttributeDataSeed[] = [
  // Duration attributes
  {
    id: MKT_ATTRIBUTE_DATA_SEEDS_IDS.MKT_YEAR_DURATION_ID,
    name: 'year_duration',
    description: 'Thời hạn sử dụng (năm)',
    position: 1,
    createdBySource: 'API',
  ...
  },
  {
    ...
    name: 'month_duration',
    description: 'Thời hạn sử dụng (tháng)',
    position: 2,
    createdBySource: 'API',
    createdByWorkspaceMemberId: null,
    createdByName: 'Tim A',
  ...
  {
    id: MKT_ATTRIBUTE_DATA_SEEDS_IDS.MKT_DAY_DURATION_ID,
    name: 'day_duration',
