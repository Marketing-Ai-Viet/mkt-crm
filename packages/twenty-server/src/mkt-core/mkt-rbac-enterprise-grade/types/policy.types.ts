/**
 * Policy Types for Enterprise RBAC
 * Contains all policy-related type definitions converted from enums and interfaces
 */

/**
 * Policy Evaluation Mode Type
 */
export type PolicyEvaluationMode =
  | 'STRICT' // All conditions must be met
  | 'PERMISSIVE' // Any condition can grant access
  | 'BALANCED' // Balanced approach with priority rules
  | 'AUDIT_ONLY'; // Evaluate but don't enforce
...
/**
 * Condition Operator Type for policy evaluation
 */
...
/**
 * Logical Operator Type for combining conditions
 */
