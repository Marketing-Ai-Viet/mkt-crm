...
export const MKT_TAG_DATA_SEEDS: MKT_TAG_DATA_SEED[] = [
  ...
  },
  {
    ...
    type: MKT_TAGS.SYSTEM,
    labelVn: 'Nguy cơ rời bỏ',
    labelEn: 'Potential Churn',
    position: 3,
    createdBySource: 'SYSTEM',
    createdByWorkspaceMemberId: null,
    createdByName: 'System',
  },
  {
    ...
    type: MKT_TAGS.SYSTEM,
    labelVn: 'Hỗ trợ nhiều',
    labelEn: 'Support Intensive',
    position: 4,
    createdBySource: 'SYSTEM',
    createdByWorkspaceMemberId: null,
    createdByName: 'System',
  ...
  },
  {
    ...
    type: MKT_TAGS.SYSTEM,
    labelVn: 'Khách hàng tiềm năng doanh nghiệp',
    labelEn: 'Enterprise Prospect',
    position: 9,
    createdBySource: 'SYSTEM',
    createdByWorkspaceMemberId: null,
    createdByName: 'System',
