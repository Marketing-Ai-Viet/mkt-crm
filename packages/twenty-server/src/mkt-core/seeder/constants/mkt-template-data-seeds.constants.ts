...
import { ORDER_EMAIL_TEMPLATE } from 'src/mkt-core/seeder/email-seeder/mkt-order.email-template';
import { MKT_TEMPLATE_EXAMPLES } from 'src/mkt-core/seeder/email-seeder/mkt-template.example';
