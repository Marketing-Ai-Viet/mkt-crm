...
export const MKT_ORGANIZATION_LEVEL_FIELD_IDS = {
  ...
  // business rules - moved to Data Access Policy
  // defaultPermissions: removed - now managed via RBAC policies
  // accessLimitations: removed - now managed via RBAC policies
  // display & status
