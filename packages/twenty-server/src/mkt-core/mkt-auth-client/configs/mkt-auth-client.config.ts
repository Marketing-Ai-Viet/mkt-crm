...
export const MktAuthTokenConfigSchema = z.object({
  ...
  MKT_AUTH_TOKEN_SAFETY_MARGIN_MS: positiveIntEnvSchema(
    MKT_AUTH_DEFAULTS.TOKEN.SAFETY_MARGIN_MS,
  ),
});
...
export function parseMktAuthClientConfig(): MktAuthClientEnvConfig {
  const envConfig = {
    ...
    MKT_AUTH_TOKEN_SAFETY_MARGIN_MS:
      process.env.MKT_AUTH_TOKEN_SAFETY_MARGIN_MS,
...
function getDefaultOptionalConfig() {
  return {
    ...
    MKT_AUTH_TOKEN_SAFETY_MARGIN_MS: MKT_AUTH_DEFAULTS.TOKEN.SAFETY_MARGIN_MS,
...
export function mktAuthClientConfigFactory() {
  ...
  return {
    ...
    token: {
      ...
      safetyMarginMs: env.MKT_AUTH_TOKEN_SAFETY_MARGIN_MS,
    },
    cache: {
